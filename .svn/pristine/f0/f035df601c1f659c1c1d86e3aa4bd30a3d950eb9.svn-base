...
// These calibration settings works with my TFTM035-6
// They MIGHT work on your display module, but you should run the
// calibration sketch anyway



#define CAL_X 0x002ACF26UL  //ER-TFTM035-6
#define CAL_Y 0x00210F7EUL  //ER-TFTM035-6
#define CAL_S 0x0013F1DFUL  //ER-TFTM035-6

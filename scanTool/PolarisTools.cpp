...
void drawRZRTOOL()
{
    ...
    case 1:
        ...
        break;
    case 2:
        drawRoundBtn(140, 80, 305, 130, F("Scan DTC"), menuBackground, menuBtnBorder, menuBtnText, CENTER);
        break;
    case 3:
        drawRoundBtn(310, 80, 475, 130, F("Clear DTC"), menuBackground, menuBtnBorder, menuBtnText, CENTER);
        break;
    case 4:
